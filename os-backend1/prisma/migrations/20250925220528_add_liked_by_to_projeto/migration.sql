...
INSERT INTO "new_Projeto" ("autorId", "comentarios", "createdAt", "descricao", "id", "likes", "titulo") SELECT "autorId", "comentarios", "createdAt", "descricao", "id", "likes", "titulo" FROM "Projeto";
DROP TABLE "Projeto";
